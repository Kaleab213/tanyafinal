...
import blogs_img1 from "../assets/Images/blogs_img1.jpg";
import blogs_img2 from "../assets/Images/blogs_img2.jpg";
import blogs_img3 from "../assets/Images/blogs_img3.jpg";
import blogs_img4 from "../assets/Images/blogs_img4.jpg";
import blogs_img5 from "../assets/Images/blogs_img5.jpg";
      ...
      <div className="flex justify-center items-center max-w-fit-content mt-10">
        <div className="m-10">
          <div className="justify-center items-center md:flex md:justify-center">
            <Cardd img={blogs_img1} />
            <Cardd img={blogs_img2} />
          </div>
          <div className="justify-center items-center md:flex md:justify-center">
            <Cardd img={blogs_img3} />
            <Cardd img={blogs_img4} />
          </div>
          <div className="justify-center items-center md:flex md:justify-center">
            <Cardd img={blogs_img5} />
            <Cardd img={blogs_img5} />
          </div>
