...
import project_img from "../assets/Images/projects_img.jpg";
import projects_img1 from "../assets/Images/projects_img1.jpg";
import projects_img2 from "../assets/Images/projects_img2.jpg";
      ...
      <div className="flex justify-center items-center max-w-fit-content mt-10">
        <div className="m-10">
          <div className="justify-center items-center md:flex md:justify-center">
            <Cardd img={project_img} />
            <Cardd img={project_img} />
          </div>
          <div className="justify-center items-center md:flex md:justify-center">
            <Cardd img={projects_img1} />
            <Cardd img={projects_img2} />
          </div>
